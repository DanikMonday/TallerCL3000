            ...
            <div className='carrito'>
                        ...
                        <>
                                    <div className="cont-prod-res" key={producto.id}>
                                            <div className='res-items'>
                                                <div><p className='cantidad'>{producto.cantidad} Und. </p></div>
...

                {
                    carrito.map((producto)=>(
                        <>
                                    <div className="cont-prod-res" key={producto.id}>
                                             <ReactWhatsapp number='+57-316-406-6946' message={`"Hola, revisé tu página web y me interesan estos productos:" ${carrito.map(item =>producto.cantidad + producto.title)}`}><div><Link to="/Resumen" className='btn-wa'>ENVIAR PEDIDO VÍA WhatsApp...<BsWhatsapp></BsWhatsapp></Link></div>
                                           </ReactWhatsapp>
                                    </div>
